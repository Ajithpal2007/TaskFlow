    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          // THE MAGIC LINE: Forcing width via React state
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed inset-y-0 z-20 h-full w-4 hidden md:flex transition-all ease-linear",
        "group-data-[side=left]:left-[calc(var(--sidebar-width)-0.75rem)]",
        "group-data-[side=right]:right-[calc(var(--sidebar-width)-0.75rem)]",
        "group-data-[collapsible=offcanvas]:left-0",
        "group-data-[side=right]:group-data-[collapsible=offcanvas]:right-0",
